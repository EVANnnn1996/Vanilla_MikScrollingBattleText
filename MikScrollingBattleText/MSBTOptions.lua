...
function MikSBTOpt.InitEvents()
 ...
 index = 8;		evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_EVADE";
 index = 9;		evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_DAMAGE";
 index = 10;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_DOT";
 index = 11;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_MISS";
 index = 12;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_DODGE";
 index = 13;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_PARRY";
 index = 14;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_BLOCK";
 index = 15;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_RESIST";
 index = 16;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_ABSORB";
 index = 17;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_IMMUNE";
 index = 18;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_REFLECT";
 index = 19;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_SPELL_EVADE";
 index = 20;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_HEAL";
 index = 21;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_HOT";
 index = 22;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_ENVIRONMENTAL";
 index = 23;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_DAMAGE";
 index = 24;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_MISS";
 index = 25;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_DODGE";
 index = 26;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_PARRY";
 index = 27;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_BLOCK";
 index = 28;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_ABSORB";
 index = 29;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_IMMUNE";
 index = 30;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_EVADE";
 index = 31;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_DAMAGE";
 index = 32;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_DOT";
 index = 33;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_MISS";
 index = 34;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_DODGE";
 index = 35;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_PARRY";
 index = 36;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_BLOCK";
 index = 37;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_RESIST";
 index = 38;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_ABSORB";
 index = 39;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_IMMUNE";
 index = 40;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_EVADE";
 index = 41;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_SPELL_REFLECT";
 index = 42;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_HEAL";
 index = 43;	evtData[index].EventType = "MSBT_EVENTTYPE_INCOMING_PET_HOT";
